...
function post_boat(name, type, length, public=true, slip=null, owner){
    var key = datastore.key(BOAT);
	const new_boat = {"name": name, "type": type, "length": length, "public": public, "slip": slip, "owner": owner};
    ...
    .then(slip => {
        if (slip[0] === undefined || slip[0] === null) {
            ...
            const slip_res = {
                ...
                self: req.protocol + "://" + req.get("host") + "/slips/" + parseInt(req.params.slip_id)
            };
